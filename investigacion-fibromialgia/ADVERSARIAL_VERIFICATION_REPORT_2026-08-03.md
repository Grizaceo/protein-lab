...
- **Substance P/TAC1: PARCIAL-MEJORADO.** Russell 1994 (PMID 7526868, 1028 citas) — SP elevado 3-fold en CSF de FM, pero **"no correlaciona con severidad del dolor"**. Tsilioni 2016 lo ve elevado en suero. Corregido 2026-08-03: el gen real de Substance P es TAC1 (FC=2.10, p=0.0002 en GSE221921), no PENK. PENK (encefalinas) es hallazgo opioide separado.
  - ⚠️ **Precedente adverso crítico:** BDNF y NGF están elevados en CSF de FM pero **NO en plasma** (revisión PMC10341963). Los neuropéptidos NO siempre se trasladan al compartimento periférico. La correlación plasma↔CSF de SP **no está establecida** — hay evidencia de que neuropéptidos hermanos fallan en ese traslado. El grade HIGH de TAC1/SP (corregido 2026-08-03) debe mantener la advertencia de que es el proxy con traslado menos seguro.
